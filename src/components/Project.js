        ...
        <div className="mainContents">
            <div className="center_section portfolioSec">
                ...
                <div className="row ProjSec">
                    <button className="btn projsBtn">
                        <a href="https://employee-directory-react0001.herokuapp.com/" target="_blank">
                            <img className="projpic" src="../Img/empSearch.png" alt="empSearch landing page" />
                            <p className="projname">Employee Search</p>
                        </a>
                    </button>
                    <div className="col-0.5"></div>
                    <div className="col-6 descBox" >
                        <p className="projDesc">Built with React.js, randomuser API </p>
                        <p className="projDesc">Responsible for building and maintaining the full app</p>
                ...
                <div className="row ProjSec">
                    <button className="btn projsBtn">
                        <a href="https://gitcomm-it.herokuapp.com/" target="_blank">
                            <img className="projpic" src="../Img/gitCommit.png" alt="gitCommit landing page" />
                            <p className="projname">Git Comm.it</p>
                        </a>
                    </button>
                    <div className="col-0.5"></div>
                    <div className="col-6 descBox" >
                        <p className="projDesc">Built with React.js, MySQL, Node.js, Express.js, Oauth2 login, github API </p>
                        <p className="projDesc">Responsible for backend, authentication</p>
                        <p className="descBreak" ></p>
                ...
                <div className="row ProjSec">
                    <button className=" btn projsBtn">
                        <a href="https://guarded-everglades-88887.herokuapp.com/" target="_blank">
                            <img className="projpic" src="../Img/Quarantini.png" alt="Quarantini landing page" />
                            <p className="projname">Quarantini</p>
                        </a>
                    </button>
                    <div className="col-0.5"></div>
                    <div className="col-6 descBox" >
                        <p className="projDesc">Built with JQuery, MySQL, Node.js, Express.js, passport.js, cocktaildb API </p>
                        <p className="projDesc">Responsible for backend and frontend functions</p>
                        <p className="descBreak" ></p>
                ...
                <div className="row ProjSec">
                    <button className=" btn projsBtn">
                        <a href="https://zmo2.github.io/weatherDashboard/" target="_blank">
                            <img className="projpic" src="./Img/weatherDash.png" alt="image of weather dashboard" />
                            <p className="projname">Weather Dashboard</p>
                        </a>
                    </button>
                    <div className="col-0.5"></div>
                    <div className="col-6 descBox" >
                        <p className="projDesc">Built with JQuery, HTML, CSS, open weather API </p>
                        <p className="projDesc">Responsible for building and maintaining the full app</p>
                        <p className="descBreak" ></p>
                ...
                <div className="row ProjSec">
                    <button className=" btn projsBtn">
                        <a href="https://github.com/yechan96/bootcamp_project1" target="_blank">
                            <img className="projpic" src="./Img/bkSearch.png" alt="image of booksearch landing page" />
                            <p className="projname">Book Search</p>
                        </a>
                    </button>
                    <div className="col-0.5"></div>
                    <div className="col-6 descBox" >
                        <p className="projDesc">Built with JQuery, HTML, CSS, open weather API, itunes API, openlibrary API </p>
                        <p className="projDesc">Responsible for book search and rendering</p>
                        <p className="descBreak" ></p>
                ...
                <div className="row ProjSec">
                    <button className=" btn projsBtn">
                        <a href="https://zmo2.github.io/password-generator/" target="_blank">
                            <img className="projpic" src="./Img/ranPassGen.png" alt="image of random password generator page" />
                            <p className="projname">Random Password Generator</p>
                        </a>
                    </button>
                    <div className="col-0.5"></div>
                    <div className="col-6 descBox" >
                        <p className="projDesc">Built with javascript, HTML, CSS </p>
                        <p className="projDesc">Responsible for building and maintaining the full app</p>
                        <p className="descBreak" ></p>
