                ...
                <div className="row ProjSec">
                    <button className="col-sm-5 btn projsBtn">
                        <a href="https://note-taker-0.herokuapp.com/notes" target="_blank">
                            <img className="projpic" src="../Img/NoteTaker.png" alt="NoteTaker landing page" style={{ width: '200px' }} />
                    ...
                    <button className="col-sm-5 btn projsBtn">
                        <a href="https://guarded-everglades-88887.herokuapp.com/" target="_blank">
                            <img className="projpic" src="../Img/Quarantini.png" alt="Quarantini landing page" style={{ width: '200px' }} />
                ...
                <div className="row ProjSec">
                    <button className="col-sm-5 btn projsBtn">
                        <a href="https://zmo2.github.io/weatherDashboard/" target="_blank">
                            <img className="projpic" src="./Img/weatherDash.png" alt="image of weather dashboard" style={{ width: '200px' }} />
                    ...
                    <button className="col-sm-5 btn projsBtn">
                        <a href="https://github.com/yechan96/bootcamp_project1" target="_blank">
                            <img className="projpic" src="./Img/bkSearch.png" alt="image of booksearch landing page" style={{ width: '200px' }} />
                ...
                <div className="row ProjSec">
                    <button className="col-sm-5 btn projsBtn">
                        <a href="https://zmo2.github.io/password-generator/" target="_blank">
                            <img className="projpic" src="./Img/ranPassGen.png" alt="image of random password generator page" style={{ width: '200px' }} />
                    ...
                    <button className="col-sm-5 btn projsBtn">
                        <a href="https://immense-plateau-51641.herokuapp.com/" target="_blank">
                            <img className="projpic" src="./Img/EatDaBurger.png" alt="Eat-Da-Burger page" style={{ width: '200px' }} />
